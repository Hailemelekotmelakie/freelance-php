        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 form login-form">
                <form action="login-user.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control" id="password" type="password" name="password" pattern="(?=.*[a-z]).{8,}" title="Must contain lowercase letter, and at least 8 or more characters" autocomplete="off"  placeholder="Password" data-toggle="password" value="" required>
                    </div>
