    ...
    <div class="jobsNewSummary ">
            <table width="100%">
              <tr  style="vertical-align: top;">
                <td >
                <div class="itemUpper">
                    <div class="CategoryOfJobs"><?php echo $row['jobCategory']; ?></div>
                    <div style="color:#076eaa;" class="priceAndTime"> 
                    ...
                    <div class="h2Find"><?php echo nl2br($row['jobDescription']); ?></div>


                    <div  style="color:#076eaa;" class="priceAndTime">
                        <!-- <img style="color:red;width: 12px; height: 12 px;" src="images/people-carry-box-solid.svg" alt="">  -->
                        <?php echo "Delivery date ".$row['jobDeadline']; ?> </div>
