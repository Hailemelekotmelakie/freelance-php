...
if(!($_SESSION['email'] && $_SESSION['password'])){
 ...
 {  
      ...
      {  
           ...
           header("location:RandomJobs.php?search=" . $query);  
      }  
 }  
 ?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/JobsSearch.css">
                ...
                <ul  class="nav navbar-nav navbar-right">
                    ...
                    <li style="z-index:1;" class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="about-us">
                            ...
                            <li><a href="../../Default pagesAM/afterLogin/RandomJobs.php">ወደ አማርኛ</a></li>
        ...
        <h1>
         <p>
            <?php 
             ...
             ?>
             <img width="90%" height="auto" src="images/welcome.jpg">
         <p class="nameTransformation">Name: <?php echo $rown['name']." &nbsp;&nbsp;&nbsp; Email: ".$rown['email']; ?></p></h1>
            <?php
                }
            ?>
        </p></h1>
...
<!-- search -->
 ...
 <!-- </div> -->
   ...
   <div id="buttonListsDiv" class="buttonListsDiv">
      ...
      <input class="buttonsList buttonsListActive" onclick="location.href='../../Default pages/afterLogin/RandomJobs.php';" type="button" name="randomJobs" value="Jobs Lists">
      <input class="buttonsList" onclick="location.href='../../Default pages/afterLogin/RecentJobs.php';" type="button" name="recentRecent" value="Recent Jobs">
      ...
      <!-- jobs1 -->
                     ...
                     {  
                          ...
                          $sqlSpecific = "SELECT * FROM jobs WHERE " . $condition;  
           ...
           <?php
                ...
                $jobShow=0;
                $sqlAll = "SELECT * FROM jobs where jobShow ='$jobShow' order by rand() limit 20";
                $resultAll = mysqli_query($con, $sqlAll);
                while($rowAll = mysqli_fetch_assoc($resultAll)) {
                         ?>
                  <div class="singleMilestoneDes">
                     <div class="jobsCategory">
                        <p class="jobsCategoryText"><?php echo $rowAll['jobCategory']; ?></p>
                     </div>
                     <div class="jobsParagraph"> 
                        <p class="jobsParagraphText">    
                              <?php echo "Delivery date ".$rowAll['jobDeadline']; ?>
                        </p>  
                        <p class="jobsParagraphText">    
                              <?php echo nl2br($rowAll['jobDescription']); ?>
                        </p>   
                     <div class="jobsFootprint">
                       <p  class="jobsFootprintText"><?php echo "Budget ".$rowAll['jobBudget']." ETB - "."Posted ".get_time_ago($rowAll["timeAgo"]); ?></p>
                        <center>
                             <?php 
                              echo '<a class="contactMeButton"  href="..\..\Default pages\chatting\chatBot.php?ea0662459db42c7104766103f0d6b675='.$rowAll["jobOwnerID"].'">'."Contact Me".'</a>';
                             ?>
                          </center>        
                       </div>
                    </div>
